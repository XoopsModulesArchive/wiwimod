DELETE %%wiwimod_profiles, %%wiwimod_prof_groups
  FROM %%wiwimod_profiles, %%wiwimod_prof_groups
 WHERE %%wiwimod_profiles.prid = %%wiwimod_prof_groups.prid AND %%wiwimod_profiles.prname IN ('Open content', 'Public content', 'Private content');
