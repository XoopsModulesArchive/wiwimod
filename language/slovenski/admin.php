...
define('_AM_WIWI_DELREDIR_TXT', 'Izberite nov profil za strani, ki ste jih prilepili na to stran.');
...
define('_AM_WIWI_CLEANUPDB_BTN', 'Poèistite podatkovno bazo');
...
define('_AM_WIWI_CONFIRMDEL_MSG', 'Ste preprièani v izbris te Wiwi strani');
define('_AM_WIWI_CONFIRMFIX_MSG', 'Ste preprièani, da želite popraviti to Wiwi stran');
