...
define('_AM_WIWI_EDITACL_SAVE_BTN', 'Grabar');
...
define('_AM_WIWI_HISTORY_FLD', 'Quién puede ver el historico de revisiones :');
...
define('_AM_WIWI_DELCONFIRM_OPT', 'SI, quiero suprimir este perfil de acceso.');
...
define('_AM_WIWI_CONFIRMFIX_MSG', 'Está seguro de suprimir todas las revisiones anteriores a esta ?');
define('_AM_WIWI_CONFIRMCLEAN_MSG', 'Está seguro de suprimir las más antiguas revisiones ?');
define('_AM_WIWI_PRFSAVESUCCESS_MSG', 'Perfil grabado en la base de datos');
define('_AM_WIWI_PRFSAVEFAILED_MSG', 'Error durante la grabación del perfil.');
define('_AM_WIWI_ERRDELETE_MSG', 'Error : imposible suprimir el perfil');
