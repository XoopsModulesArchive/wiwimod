...
define('_MD_WIWI_PAGEVIEW_BTN', 'Vuelta a la página');
...
define('_MD_WIWI_ERRORINSERT_MSG', 'Error mientras se actualizaba la base de datos!');
define('_MD_WIWI_EDITCONFLICT_MSG', 'Conflicto de versiones! - Sus modificaciones han sido rechazadas!');
define('_MD_WIWI_NOREADACCESS_MSG', '<br><h4>Lo siento , página de acceso protegido.</h4><br>');
define('_MD_WIWI_NOWRITEACCESS_MSG', '<br><h4>Lo siento , no tiene privilegios para modificar esta página.</h4><br>');
