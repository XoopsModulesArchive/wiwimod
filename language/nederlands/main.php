...
define('_MD_WIWI_FIX_BTN', 'Fixeer');
...
define('_MD_WIWI_MODIFIED_COL', 'wijziging');
...
define('_MD_WIWI_NOREADACCESS_MSG', '<br><h4>Helaas..., je hebt geen toegang tot deze pagina.</h4><br>');

// Added for Wiwi 0.8.2
define('_MD_WIWI_NOWRITEACCESS_MSG', '<br><h4>Helaas, je hebt geen schrijf-/bewerkrechten voor deze pagina.</h4><br>');
