...
define('_AM_WIWI_DELCONFIRM_TXT', 'Je gaat een profiel verwijderen. Bevestig dit verzoek door de checkbox aan te vinken.');
...
define('_AM_WIWI_CONFIRMDEL_MSG', 'Weet je zeker dat je deze wiwi pagina wilt verwijderen?');
define('_AM_WIWI_CONFIRMFIX_MSG', 'Weet je zeker dat je deze wiwi pagina wilt fixeren?');
define('_AM_WIWI_CONFIRMCLEAN_MSG', 'Weet je zeker dat je de wiwi database wilt opschonen?');
